...
**Current release:** v1.0.3 — all four packages (`@eudi-verify/server`, `@eudi-verify/client`, `@eudi-verify/embed`, `@eudi-verify/react`) share a single version line. Stable integration API, demo verification engine only. See [Current Limitations](../README.md#current-limitations).
