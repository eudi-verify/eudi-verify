...
- Updated dependencies [fb3d627]
  - @eudi-verify/client@1.0.0

## 0.1.2

### Patch Changes

- 31834ee: Improve widget accessibility: fix verified-state focus, focus cancel on waitingForWallet, aria-busy during loading, and aria-describedby on error retry buttons.
...
- Updated dependencies [a056e1b]
  - @eudi-verify/client@0.1.1
